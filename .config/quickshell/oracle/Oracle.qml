...
Singleton {
  ...
  // The album art is the thing you recognise a track toast by from across
  ...
  readonly property var specs: [
    ...
    // ── the checkup ──
    // Readouts like the About rows, filled by scripts/doctor.sh — see
  ...
  // "ok", "warn" or "bad" — how a Health row is coloured. Everything else
  ...
  function runCheckup() {
    ...
    doctorProc.command = ["bash", Quickshell.shellDir + "/scripts/doctor.sh",
