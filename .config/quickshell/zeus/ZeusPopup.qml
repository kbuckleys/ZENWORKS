...
PanelWindow {
          ...
          Column {
            ...
            GridView {
              ...
              delegate: Item {
                ...
                Rectangle {
                  anchors.fill: parent
                  color: index === popup.sel ? Zenon.border : "transparent"
                }
              ...
              ListView {
                ...
                delegate: Item {
                  ...
                  Rectangle {
                    anchors.fill: parent
                    visible: !modelData.head
                    color: soundRow.selected ? Zenon.border
                      : (rowHov.hovered ? Zenon.border : "transparent")
                  }
                    ...
                    Item {
                      ...
                      Rectangle {
                        ...
                        color: profHov.hovered
                          ...
                          : "transparent"
                        border.width: 1
                        border.color: profHov.hovered ? Zenon.green : Zenon.border
  ...
  component StatRow: Item {
    ...
    Rectangle {
      ...
      radius: 6
      color: rowHover.hovered ? Zenon.border : "transparent"
      Behavior on color { ColorAnimation { duration: Zenon.fast } }
    }
