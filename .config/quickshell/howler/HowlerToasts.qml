  ...
  Column {
    ...
    ListView {
      ...
      delegate: Item {
        ...
        // The ordinary shadow every card in this shell casts. The glow
        // below is a different thing wearing the same component: red,
        // conditional, and about urgency rather than depth. A toast needs
        // both — it floats over the desktop like any other card.
        MenuShadow {
          panel: card
        ...
        ClippingRectangle {
          ...
          color: Howler.bg
          border.color: toast.critical ? Howler.accent : Zenon.border
