...
PanelWindow {
  ...
  FontMetrics { id: resFm; font.family: Zenon.face; font.weight: Font.Bold; font.pixelSize: 26 }
  ...
  readonly property int panelWidth: {
    const want = Math.max(
      ...
      exprFm.advanceWidth((popup.fromHistory ? "↺ " : "") + popup.shownExpr + "  =") + 60,
      resFm.advanceWidth(popup.shownResult) + 60);
