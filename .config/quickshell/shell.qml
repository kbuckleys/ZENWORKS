...
ShellRoot {
  ...
  // A layer's panel is a fixed 1000 wide (FolioPopup.qml:546 and its
  // siblings) and does not track the pill, so for all but the last sliver
  // of the travel its content is WIDER THAN THE CONTAINER. Any opacity it
