...
PanelWindow {
                    ...
                    Rectangle {
                      ...
                      color: dayCell.isToday ? Zenon.cyan
                        : (dayCell.isSel
                            ...
                            : (dayMa.containsMouse ? Zenon.border : "transparent"))
                      border.color: (dayCell.isSel && !dayCell.isToday) ? Zenon.cyan : "transparent"
                      border.width: 1
                      Behavior on color { ColorAnimation { duration: Zenon.fast } }
                    }
                ...
                delegate: Item {
                  ...
                  Rectangle {
                    ...
                    color: dayStrip.isSel
                      ? Qt.rgba(Zenon.cyan.r, Zenon.cyan.g, Zenon.cyan.b, 0.16)
                      : (stripMa.containsMouse ? Zenon.border : "transparent")
          ...
          Row {
            ...
            Column {
              ...
              Rectangle {
                ...
                height: popup.emptyH
                radius: 8
                color: emptyMa.containsMouse ? Zenon.border : "transparent"
                border.color: Zenon.border
                border.width: 1
                Behavior on color { ColorAnimation { duration: Zenon.fast } }
  ...
  component PillButton: Rectangle {
    ...
    border.color: pill.lit ? pill.accent : Zenon.border
    border.width: 1
