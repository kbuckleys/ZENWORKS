...
CardMenu {
  ...
  // The first card opens flush against the pill — square on that edge, the
  // way a submenu is square against its parent. Which edge follows the bar.
  squareEdge: root.isSubMenu ? "" : (Zenon.barTop ? "top" : "bottom")
