...
PanelWindow {
  ...
  readonly property real panelX: popup.collapsing ? 0.985 + 0.015 * popup.showFactor : 0.94 + 0.06 * popup.showFactor
  readonly property real panelY: popup.collapsing ? 0.82 + 0.18 * popup.showFactor : 0.90 + 0.10 * popup.showFactor
  ...
  Item {
    ...
    anchors {
      ...
      bottomMargin: popup.screen && popup.statusbar && popup.statusbar.screen && popup.screen.name === popup.statusbar.screen.name ? popup.statusbar.height : 0
    }
    z: 1
