  ...
  Rectangle {
    ...
    Item {
      ...
      Row {
        ...
        Rectangle {
          id: inputBar
          width: input.text.length > 0
            ? Math.min(10 + promptText.width + input.contentWidth + 12, popup.width * 0.7)
            : 0
            ...
            TextInput {
              ...
              Rectangle {
                ...
                SequentialAnimation on opacity {
                  running: input.activeFocus && popup.mode === "search" && input.text.length > 0
        ...
        ListView {
          ...
          delegate: Item {
            ...
            width: rowText.implicitWidth + 36
      ...
      Row {
        ...
        ListView {
          ...
          delegate: Item {
            required property var modelData
            required property int index
            width: pickerText.implicitWidth + 36
            height: ListView.view.height
